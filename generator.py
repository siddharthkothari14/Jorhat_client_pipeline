...
def add_page_content(canvas_obj, page_data, name, timestamp, client_name=None):
    ...
    canvas_obj.drawString(50, 690, "Place: Jorhat")
    ...
    # Add footer
    canvas_obj.drawString(50, 100, "Thanking You,")
    canvas_obj.drawString(50, 80, "Signature: _________________")
    canvas_obj.drawString(50, 60, f"Client ID: {name}")
    canvas_obj.drawString(50, 40, f"Client Name: {client_name or name}")
